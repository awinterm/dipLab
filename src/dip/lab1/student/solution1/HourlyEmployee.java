...
public class HourlyEmployee implements Employee {
    ...
    /** default constructor. Is this the best way to go? 
     no full reason stated in SalriedEmployee class.
     */


    /**
     * Convenience constructor. Is this the best way to go?
     * In this case yes. Forces the properties to be set at construction.
     * So you never have an employee walking around with null values.
    ...
    *   you can't just say if tHFY > (40hrs a week times 52 weeks) because 
    *   hourly employees are paid there overtime on a weekly basis. I hope this 
    *   isn't part of the thinking hard about this project that Jim talked about in 
    *   his comments and rather over thinking this project. Since it is not 
    *   DIP related I'll only come back to this issue if he asks after lab review.
    * 
     * @return = annual Wages. 
    */
    @Override
